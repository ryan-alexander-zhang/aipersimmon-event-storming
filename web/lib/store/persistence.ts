...
// a corrupt or stale entry is rejected on load (importJSON) and the app starts
// empty instead of crashing (us-00005-FR-2).
...
export function saveModel(nodes: ESNode[], edges: ESEdge[]): void {
...
export function loadModel(): { nodes: ESNode[]; edges: ESEdge[] } | null {
